...
public enum ResourceChickenType {
    ...
    CAVE("Cave Chicken", ChatColor.GRAY, 0.075, List.of(new LootGroup(1.0, new Loot(Material.SANDSTONE, 1.0, 50, 100), new Loot(Material.GRANITE, 1.0, 50, 100), new Loot(Material.ANDESITE, 1.0, 50, 100), new Loot(Material.DIRT, 1.0, 50, 100), new Loot(Material.GRAVEL, 1.0, 50, 100), new Loot(Material.STONE, 1.0, 50, 100), new Loot(Material.COBBLED_DEEPSLATE, 0.5, 50, 100), new Loot(Material.COBBLED_DEEPSLATE, 0.5, 50, 100), new Loot(Material.TUFF, 1.0, 50, 100), new Loot(Material.CALCITE, 1.0, 50, 100)), new LootGroup(0.5, new Loot(Material.COAL_ORE, 1.0, 10, 20), new Loot(Material.REDSTONE_ORE, 1.0, 10, 20), new Loot(Material.LAPIS_ORE, 1.0, 10, 20), new Loot(Material.DEEPSLATE_COAL_ORE, 1.0, 10, 20), new Loot(Material.DEEPSLATE_REDSTONE_ORE, 1.0, 10, 20), new Loot(Material.DEEPSLATE_LAPIS_ORE, 1.0, 10, 20)),new LootGroup(0.3, new Loot(Material.IRON_ORE, 1.0, 5, 10), new Loot(Material.GOLD_ORE, 1.0, 5, 10), new Loot(Material.COPPER_ORE, 1.0, 5, 10), new Loot(Material.DEEPSLATE_IRON_ORE, 1.0, 5, 10), new Loot(Material.DEEPSLATE_GOLD_ORE, 1.0, 5, 10), new Loot(Material.DEEPSLATE_COPPER_ORE, 1.0, 5, 10)),new LootGroup(0.1,new Loot(Material.DIAMOND_ORE, 1.0, 5, 10), new Loot(Material.EMERALD_ORE, 1.0, 5, 10), new Loot(Material.DEEPSLATE_DIAMOND_ORE, 1.0, 5, 10), new Loot(Material.DEEPSLATE_EMERALD_ORE, 1.0, 5, 10)), new Loot(Material.AMETHYST_SHARD, 0.25, 3, 9))),
    ...
    NETHER("Nether Chicken", ChatColor.DARK_RED, 0.075, List.of(new Loot(Material.NETHERRACK, 1.0, 20, 50), new Loot(Material.SOUL_SAND, 0.8, 10, 20), new LootGroup(0.4,new Loot(Material.NETHER_QUARTZ_ORE, 0.25, 5, 10), new Loot(Material.QUARTZ, 0.75, 10, 20)), new Loot(Material.ANCIENT_DEBRIS, 0.05, 1, 3), new Loot(Material.NETHER_GOLD_ORE, 0.25, 1, 10))),
    ...
    public ArrayList<String> listLootRaw() {
        ArrayList<String> strings = new ArrayList<>();
        loot.forEach(l -> {
            strings.addAll(l.listRaw());
        });
        return strings;
    }
